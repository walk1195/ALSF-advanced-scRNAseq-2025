...
# Inputs --------------------------------------
# main data directory
data_dir <- file.path("data", "glioblastoma-10x") # could also write as data/glioblastoma-10x
...
raw_sce <- DropletUtils::read10xCounts(
  raw_matrix_dir,
  col.names = TRUE # ensures that barcodes are set as colnames
)
```
...
# could use saveRDS(), base function
